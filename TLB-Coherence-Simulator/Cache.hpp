...
public:
    ...
    void handle_coherence_action(CoherenceAction coh_action, uint64_t addr, uint64_t tid, bool is_large, unsigned int curr_latency, bool is_translation, bool same_cache_sys);
